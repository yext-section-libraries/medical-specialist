...
type MedicalSpecialistBannerProps = {
  data: {
...
const MedicalSpecialistBannerFields: YextFields<MedicalSpecialistBannerProps> = {
  data: {
    label: "Banner Text",
    type: "object",
    objectFields: {
...
const MedicalSpecialistBannerComponent: PuckComponent<MedicalSpecialistBannerProps> = ({
  data,
  styles,
  section,
  puck,
...
export const MedicalSpecialistBanner: YextComponentConfig<MedicalSpecialistBannerProps> = {
  ...
  render: (props) => (
    ...
    >
      <MedicalSpecialistBannerComponent {...props} />
    </VisibilityWrapper>
  ),
};
