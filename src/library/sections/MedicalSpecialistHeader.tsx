...
type MedicalSpecialistHeaderProps = {
...
.medical-specialist-header__cta {
  text-decoration: none;
}

.medical-specialist-header__nav-link {
  text-decoration: none;
}
`;
...
const MedicalSpecialistHeaderFields: YextFields<MedicalSpecialistHeaderProps> =
  {
    variant: {
      label: "Variant",
      type: "select",
...
const MedicalSpecialistHeaderComponent: PuckComponent<
  MedicalSpecialistHeaderProps
> = (props) => {
          ...
          {ctaItems.map((item, index) => (
            ...
            >
              <ComprehensiveCTA
                ...
                className="medical-specialist-header__cta inline-flex h-10 items-center justify-center px-5 transition-opacity hover:opacity-90"
              />
            </EntityField>
          ))}
        </div>
          ...
          ? navigationLinks.map((item) => (
              <li key={`${item.eventName}-${item.link}`}>
                <Link
                  ...
                  target={item.openInNewTab ? "_blank" : undefined}
                  rel={item.openInNewTab ? "noopener noreferrer" : undefined}
                  className="medical-specialist-header__nav-link inline-flex items-center gap-2 transition-opacity hover:opacity-80"
                      ...
                      {drawerCtaItems.map((item, index) => (
                        ...
                        >
                          <ComprehensiveCTA
                            ...
                            className="medical-specialist-header__cta inline-flex h-10 w-full items-center justify-center px-5 transition-opacity hover:opacity-90"
                          />
                        </EntityField>
                      ))}
                    </div>
...
export const MedicalSpecialistHeader: YextComponentConfig<MedicalSpecialistHeaderProps> =
  {
    label: "Header",
    fields: MedicalSpecialistHeaderFields,
    defaultProps: {
      ...
      logoImage: {
        ...
        image: {
          ...
          constantValue: {
            ...
            width: 450,
            height: 450,
            alternateText: "Medical Specialist",
          },
        },
        url: {
          field: "",
    ...
    render: (props) => (
      <AnalyticsScopeProvider
        name={`MedicalSpecialistHeader${getAnalyticsScopeHash(props.id)}`}
      >
        <MedicalSpecialistHeaderComponent {...props} />
      </AnalyticsScopeProvider>
    ),
  };

export const config: SectionConfig = {
  id: "MedicalSpecialistHeader",
  displayName: "Header",
  description: "Header",
